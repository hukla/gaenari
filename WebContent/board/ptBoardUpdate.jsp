                    ...
                    <div id="ptboard-write-form">
                        <form name="boardWriteForm" method="post"
                            ...
                            <table class="table ptboard-write-table">
                                <tr>
                                    <td colspan="2">
                                        <div class="ptboard-write-table-title">펫도우미 요청 글 수정</div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="ptboard-type">
                                        <div class="ptboard-type-container">
                                            <input type="radio" name="worktype" value="산책">
                                ...
                                <tr>
                                    <td colspan='2' class="ptboard-write-form-btn-group">
                                        ...
                                        <a class="btn btn-yellow ptboard-write-form-btn form-control" href="/gaenari/ptBoardList.do">리스트로 돌아가기
                                        </a>
                                    </td>
                                </tr>
                            </table>
