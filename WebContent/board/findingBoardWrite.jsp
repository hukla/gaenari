	...
	<div id="wrapper">
		...
		<div id="content"><%@ include file="/static/pages/menubar.jsp"%>
			<div class="container">
              ...
              action="findingBoardWrite.do" enctype="multipart/form-data"
              onSubmit='return checkValid()'>
              <input type="hidden" name="command" value="findingBoardWrite">
              <table class="table mboard-write-table">
                <tr>
                  <td colspan="2">
                    <div class="mboard-write-table-title">유기견 제보 게시판 글 작성</div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <select name="floc" class="form-control">
                ...
                <tr>
                  <td colspan='2' class="mboard-write-form-btn-group">
                    ...
                    <a class="btn btn-yellow mboard-write-form-btn form-control" href="/gaenari/findingBoardMain.do">리스트로 돌아가기
                    </a>
                  </td>
                </tr>
              </table>
