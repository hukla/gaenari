...
<body>
		<form name="boardWriteForm" method="post" action="findingBoardWrite.do"
		 enctype="multipart/form-data" onSubmit='return checkValid()'>

		<input type="hidden" name="command" value="findingBoardWrite">
		...
		<table align="center" cellpadding="5" cellspacing="2" width="600"
			...
			<tr>
				<td width="1220" height="20" colspan="2">
					<p align="center">
						<font size="3"><b>유기견 제보 게시판 글작성</b></font>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="150" height="20">
					<p align="right">
						<b><span style="font-size: 9pt;">발 견 장 소</span></b>
					</p>
				</td>
				<td width="200" height="20"><b><span
						style="font-size: 9pt;"> <input type="text" name="floc" size="50"></span></b></td>
			</tr>
			<tr>
	...
	<div align=center>
		<span style="font-size: 9pt;"><a href="/gaenari/findingBoardMain.do">
