...
수정: 2014-05-22, 이수진	내용: 로그인 로고 추가, 페이스북 계정 접속 버튼 추가
수정: 2014-05-23, 최성훈	내용: 회원가입 버튼에 Join액션 매핑하기
수정: 2014-05-25, 최성훈	내용: UI변경 - 캐러셀로 사진 슬라이드보기 추가
수정: 2014-05-28, 최성훈	내용: 페이스북 로그인으로 email, userid 파라미터로 넘기기
 -->
