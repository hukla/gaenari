				...
				<table border="0" width="100%" height="100%">
					<tr>
						<td width="100%" align="right">
							<input type="button" onclick="control?command=visitList'"value="방명록전체">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr>
							...
							<table border="1" align="center" width="50%" height="80%">
								...
								<tr>
									...
									<td>
										<div align="center">
											...
											<c:if
												test="${requestScope.oneVisit.wrdate eq sessionScope.today}">
								...
								<tr>
									...
									<td align="center" colspan="2" height="7%">
										<input type="button" onclick="location.href='control?command=visitDetail&index=${requestScope.index + 1}'" value="이전 글"> 
										&nbsp;&nbsp;&nbsp;&nbsp; 
										<input type="button" onclick=""value="수정하기"> 
										&nbsp;&nbsp;&nbsp;&nbsp; 
										<input type="button" onclick="" value="삭제하기">
										&nbsp;&nbsp;&nbsp;&nbsp; 
										<input type="button" onclick="location.href='control?command=visitDetail&index=${requestScope.index - 1}'" value="다음 글">
									</td>
								</tr>
							</table>
						</td>
