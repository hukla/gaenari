	...
	<table border="1" width="1350" height="630">
		<tr>
			<td colspan="2" height="20%">
				<h3>${sessionScope.user.username}님의 일정 상세보기</h3>
				<div align="right">
				...
				<table border="0" width="100%" height="100%">
					...
					<tr>
						...
						<form action="control" method="post" name="requestForm">
							...
							<input type="button" onclick="location.href='control?command=planDetail&index=${requestScope.index -1}'" value="이전 글"> 
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="button" onclick="location.href='control?command=updateFormPlan&brdno=${requestScope.onePlan.brdno}'"value="수정하기"> 
							&nbsp;&nbsp;&nbsp;&nbsp; 
							...
							&nbsp;&nbsp;&nbsp;&nbsp; 
							<input type="button" onclick="location.href='control?command=planDetail&index=${requestScope.index +1}'" value="다음 글">
								<ul class="pager">
									<li><a href="control?command=planDetail&index=${requestScope.index +1}">Previous</a></li>
									<li><a href="control?command=updateFormPlan&brdno=${requestScope.onePlan.brdno}">수정하기</a></li>
									<li><a href="javascript:deleteCheck();">삭제하기</a></li>
									<li><a href="control?command=planDetail&index=${requestScope.index -1}">Next</a></li>
								</ul>
							</form>
						</td>
					</tr>
